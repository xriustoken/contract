 ...
 * Website :  http://www.xriustoken.com/
 
 * Xrius is an exciting strategy game where players try to reach the goal in a maze.
 ...
 * 10% Burn
 * 20% Cex listing
 * 10% Server Reward Pool
 * 10% AirDrop
 * 10% Partners
 
 * No Fees on Buy / 0% Buy fee

 * In every sell transaction :
...
contract Xrius is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 10**11 * 10**9; // 1 Trillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Xrius";
    string private _symbol = "XRS";
    ...
    address public marketingWallet = 0x2439c2AEf4DaA2161Dc16A06F8ad7ceb045ecbAE;
